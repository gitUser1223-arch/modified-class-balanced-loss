    ...
    def get_loss(self, targets, mlvl_preds, mlvl_shapes=None):
        ...
        if self.loc_use_ghm:
            ...
            if loc_mask.sum() == 0:
                ...
                pos_cls_target = cls_target[loc_mask] # 计算正样本的类别标签 # new add code on 240902
                loc_loss_kwargs["pos_cls_target"] = pos_cls_target #将 pos_cls_target 添加到 loc_loss_kwargs 中 # new add code on 240902
