...
try:
    ...
    print("mqbench module not found. Ignoring the import error.")
    mqbench = None  # 设为 None，后续代码中可以检查是否成功导入
if mqbench:
    from mqbench.utils.state import enable_calibration, enable_quantization
else:
    print("Skipping mqbench-related code since the module is not found.")
#from mqbench.utils.state import enable_calibration, enable_quantization
