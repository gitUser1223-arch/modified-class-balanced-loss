...
class Saver(object):
    ...
    def load_checkpoint(ckpt_path):
        ...
        ckpt_dict = torch.load(ckpt_path, map_location=lambda storage, loc: storage.cuda(device)) # for r50 # new add code 
        #ckpt_dict = torch.load(ckpt_path)  # 用你希望的GPU id替换`device` # for r101 # new add code 
